...
urlpatterns = [
    ...
    path('portfolio/category/<int:category_id>/', PortfolioView.as_view(), name='category_project_filter'),
    path('portfolio/<int:pk>/', PortfolioDetailView.as_view(), name='portfolio_details'),
